...
class Lorem(nn.Module):
    ...
    def energy(self, params, batch):
        ...
        return jnp.sum(energies), (energies, q)
    ...
    def predict(self, params, batch, stress=False,
        ...
        _, (energies, q) = batch_energy_and_atom_energies
        ...
        results = {"energy": energy, "forces": forces, "charges": q}

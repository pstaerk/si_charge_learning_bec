...
def get_predict_fn(apply_fn, stress=False, electrostatics="ewald",
    ...
    def energy_fn(params, batch):
        ...
        return total_energy, (energies, apt, q)
    ...
    def predict(params, batch):
        ...
        _, (energies, apt, q_i) = batch_energy_and_atom_energies_and_atom_df
        ...
        # TODO: This needs to change to use the APT
        ...
        results["charges"] = q_i
        results["apt"] = apt  # will learn to target this based on DFT

...
class Critias(nn.Module):
    ...
    num_scalar: int = 16  # increase to 64, 128
    ...
    def __call__(
        ...
        masked_spherical = spherical_features * node_mask[..., None, None, None]
        ...
        if self.semilocal_spherical:
            ...
            m_zeroed = m * node_mask[..., None, None, None]
            apt += PerParticleTensorPredictor()(
                m_zeroed
            )
            apt *= node_mask[..., None, None]
            # apt += masked(
            #     PerParticleTensorPredictor(),
            #     m,
            #     node_mask[..., None, None],  # because need to mask 3x3 tensors
            # )

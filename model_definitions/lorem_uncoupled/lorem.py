...
class Lorem(nn.Module):
    ...
    def __call__(
        ...
        apt = PerParticleTensorPredictor(features=self.num_features)(nodes_spherical)
        apt *= node_mask[..., None, None]
        ...
        for _ in range(self.num_message_passing):
            ...
            # -- residual prediction --
            energy += masked(MLP(features=[d, d, 1]), nodes_scalar, node_mask)[..., 0]
            apt += PerParticleTensorPredictor(features=self.num_features)(
                nodes_spherical
            )
            apt *= node_mask[..., None, None]
        ...
        return energy, apt, scalar_charges
    ...
    def energy(self, params, batch):
        ...
        return jnp.sum(energies), (energies, apt, q)
    ...
    def predict(self, params, batch, stress=False,
        ...
        _, (energies, apt, q) = batch_energy_and_atom_energies
